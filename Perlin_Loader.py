...
from PyQt6.QtCore import (QVariantAnimation, Qt, QPointF, QRect, QSize)
from PyQt6.QtGui import QColor, QPainter, QPaintEvent, QBrush, QFont, QPainterPath
from PyQt6.QtWidgets import QFrame, QApplication, QWidget, QVBoxLayout


class PerlinLoader(QFrame):
